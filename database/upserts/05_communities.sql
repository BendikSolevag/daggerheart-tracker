...
Duneborne are often adaptable, centered, collaborative, devoted, cheerful, and observant.',
  'Oasis',
  'During a short rest, you or an ally can reroll a die used for a downtime move and take the higher result.'
),
(
  'freeborne',
  'Freeborne',
...
Frostborne are often cunning, gregarious, intrepid, purposeful, quiet, and warm.',
  'Hardy',
  'When you take a rest, you clear a Hit Point.'
),
(
  'hearthborne',
  'Hearthborne',
...
Hearthborne are often careful, generous, insular, loquacious, smiley, and traditional.',
  'Close-Knit',
  'Once per long rest, you can spend any number of Hope to grant an ally within Far range an equal number of Hope.'
),
(
  'highborne',
  'Highborne',
...
Reborne are often curious, hopeful, innocent, isolated, mournful, and uncanny.',
  'Found Family',
  'Once per rest, you can spend a Hope to use an ally’s Experience as if it were your own. When you do so, describe how your time with that ally prepared you for this moment.
