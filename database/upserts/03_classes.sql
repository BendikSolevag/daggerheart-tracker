...
-- Requires 01_domains.sql and 02_subclasses.sql to have been applied first.
...
(
  ...
  (select id from public.subclasses where slug = 'executioners-guild'),
  (select id from public.subclasses where slug = 'poisoners-guild'),
  12,
  5,
  'A list of names with several marked off or a rusted blade inscribed with an insignia',
...
(
  ...
  (select id from public.subclasses where slug = 'troubadour'),
  (select id from public.subclasses where slug = 'wordsmith'),
  10,
  5,
...
(
  ...
  (select id from public.subclasses where slug = 'juggernaut'),
  (select id from public.subclasses where slug = 'martial-artist'),
  10,
  6,
  'Hand wraps from a mentor or a book about your secret hobby',
...
(
  ...
  (select id from public.subclasses where slug = 'warden-of-the-elements'),
  (select id from public.subclasses where slug = 'warden-of-renewal'),
  10,
  6,
...
(
  ...
  (select id from public.domains where slug = 'valor'),
  (select id from public.domains where slug = 'blade'),
  (select id from public.subclasses where slug = 'stalwart'),
  (select id from public.subclasses where slug = 'vengeance'),
  9,
  7,
...
(
  ...
  (select id from public.domains where slug = 'bone'),
  (select id from public.domains where slug = 'sage'),
  (select id from public.subclasses where slug = 'beastbound'),
  (select id from public.subclasses where slug = 'wayfinder'),
  12,
  6,
...
(
  ...
  (select id from public.domains where slug = 'midnight'),
  (select id from public.domains where slug = 'grace'),
  (select id from public.subclasses where slug = 'nightwalker'),
  (select id from public.subclasses where slug = 'syndicate'),
  12,
  6,
...
(
  ...
  (select id from public.domains where slug = 'valor'),
  (select id from public.subclasses where slug = 'divine-wielder'),
  (select id from public.subclasses where slug = 'winged-sentinel'),
  9,
  7,
...
(
  ...
  (select id from public.domains where slug = 'arcana'),
  (select id from public.domains where slug = 'midnight'),
  (select id from public.subclasses where slug = 'elemental-origin'),
  (select id from public.subclasses where slug = 'primal-origin'),
  10,
  6,
...
(
  ...
  (select id from public.domains where slug = 'dread'),
  (select id from public.domains where slug = 'grace'),
  (select id from public.subclasses where slug = 'pact-of-the-endless'),
  (select id from public.subclasses where slug = 'pact-of-the-wrathful'),
  11,
  5,
  'A carving that symbolizes your patron or a ring you can’t remove',
...
(
  ...
  (select id from public.domains where slug = 'blade'),
  (select id from public.domains where slug = 'bone'),
  (select id from public.subclasses where slug = 'call-of-the-brave'),
  (select id from public.subclasses where slug = 'call-of-the-slayer'),
  11,
  6,
...
(
  ...
  (select id from public.domains where slug = 'sage'),
  (select id from public.domains where slug = 'dread'),
  (select id from public.subclasses where slug = 'hedge'),
  (select id from public.subclasses where slug = 'moon'),
  10,
  6,
  'A small, harmless pet or a scrying stone',
...
(
  ...
  (select id from public.domains where slug = 'codex'),
  (select id from public.domains where slug = 'splendor'),
  (select id from public.subclasses where slug = 'school-of-knowledge'),
  (select id from public.subclasses where slug = 'school-of-war'),
  11,
  5,
...
on conflict (slug) do update set
  ...
  domain_1_id = excluded.domain_1_id,
  domain_2_id = excluded.domain_2_id,
  subclass_1_id = excluded.subclass_1_id,
  subclass_2_id = excluded.subclass_2_id,
  starting_evasion = excluded.starting_evasion,
  starting_hit_points = excluded.starting_hit_points,
  class_items = excluded.class_items,
  hope_feature = excluded.hope_feature,
