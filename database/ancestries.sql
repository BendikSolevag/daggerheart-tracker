...
drop table if exists public.ancestries;
...
(
  'katari',
  'Katari',
  'Katari are feline humanoids with retractable claws, vertically slit pupils, and high, triangular ears. They can also have small, pointed canine teeth, soft fur, and long whiskers that assist their perception and navigation. Their ears can swivel nearly 180 degrees to detect sound, adding to their heightened senses. Katari may look more or less feline or humanoid, and about half have tails. Their skin and fur come in a wide range of hues and patterns. Their height ranges from about 3 feet to 6 ½ feet, and they live to around 150 years.',
  'Feline Instincts',
...
(
  'orc',
  'Orc',
  'Orcs are humanoids most easily recognized by their square features and boar-like tusks that protrude from their lower jaw. Tusks come in various sizes and are often decorated with ornamentation. Orcs typically live for 125 years, and unless altered, their tusks continue to grow throughout their lives. Their ears are pointed, and their hair and skin typically have green, blue, pink, or gray tones. Orcs tend toward a muscular build, and their average height ranges from 5 feet to 6 ½ feet.',
  'Sturdy',
...
(
  'ribbet',
  'Ribbet',
  'Ribbets resemble anthropomorphic frogs with protruding eyes and webbed hands and feet. They have smooth (though sometimes warty) moist skin and eyes positioned on either side of their head. Their size ranges from about 3 feet to 4 ½ feet, and they primarily move by hopping. All ribbets have webbed appendages, allowing them to swim with ease. Ribbets are born from eggs laid in water, hatch into tadpoles, and after several years grow into amphibians that can move on land. Ribbets live for approximately 100 years.',
  'Amphibious',
...
(
  'simiah',
  'Simiah',
  'Simiah resemble anthropomorphic monkeys and apes with long limbs and prehensile feet. Their appearance reflects all simian creatures, and they can be anywhere from 2 to 6 feet tall. All simiah can use their dexterous feet for nonverbal communication, work, and combat. Some also have prehensile tails. These traits grant simiah unique agility, especially for climbing and balancing. On average, simiah live for about 100 years.',
  'Natural Climber',
